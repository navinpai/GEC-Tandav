...
?>
  ...
  <?php if($user->gid>23 && $this->frontEditConflict): ?>
	<div id="k2AdminJoomfishNotice">
		<?php
		echo JText::_('Notice: Frontend editing has been disabled because Joom!Fish is installed and enabled in your website');
		//JError::raiseNotice('',JText::_('Notice: Frontend editing has been disabled because Joom!Fish is installed and enabled in your website. To hide this message, either disable the Frontend Editing option in K2\'s parameters or unpublish the JFDatabase plugin in the Plugin Manager.'));
		?>
	</div>
  <?php endif; ?>
